...
<!--                                <div class="x_panel">
                                                    ...
                                                    <div class="x_panel">
                                                        ...
                                                        <div class="x_content" style="margin-top: -15px;">
                                                            ...
                                                            <div class="form-group" style="margin-bottom: -9px;">
                                                                ...
                                                                <div class="form-group" style="margin-bottom: -9px;">
                                                                    <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12" style="margin-left: 0px;width: 102px;padding-left: 0px;">Niveau <span class="required">*</span></label>
                                                                    <div class="col-md-10 col-sm-10 col-xs-12 input-group">
                                                                        <input type="text" id="first-name" class="form-control col-md-7 col-xs-12" name="niveau" value="<s:property value="%{niveau}"></s:property>">                                                                            
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="table-responsive">
                                                                <table class="table table-striped jambo_table bulk_action">
                                                                    ...
                                                                    <tbody>
                                                                    <s:iterator value="listeDepartement">
    ...
    <script>
            jQuery(document).ready(function ($) {
                ...
                $(".add").click(function () {
                    window.location = "ajouterSortie?codeDernierDepartement=" + $('[name="codeDernierDepartement"]').val() + "&unite=" + $('[name="unite"]').val() + "&nombre=" + $('[name="nombre"]').val() + "&coms=" + $('[name="coms"]').val() + "&idDernierDepartement=" + $('[name="idDernierDepartement"]').val() + "&idDernierProjet=" + $('[name="idDernierProjet"]').val();
                });
                $(".del").click(function () {
                    window.location = $(this).data("href");
                });
